...
function init() {
    ...
    directionalLight.shadow.shadow.camera.top = 120;
...
function createChicken() {
    ...
    // Altura da perna: 1.5. O ponto de pivô da perna é -2.
    // A galinha está em y=0.
    // O ajuste da posição das partes do corpo é necessário
